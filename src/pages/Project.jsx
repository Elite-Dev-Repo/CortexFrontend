        ...
        sections={[
          {
            ...
            items: [
              ...
              { icon: Folder, label: project?.workspace_name || "Workspace", onClick: () => navigate(`/workspace/${uuid}`) },
              { icon: SquareStack, label: project?.name || "Project", active: true },
            ],
          },
        ]}
      />
